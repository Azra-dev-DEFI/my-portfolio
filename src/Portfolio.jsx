...
const Portfolio = () => {
    ...
    const myemail = 'rajahibrahim3@gmail.com';
                ...
                <div className="container mx-auto px-6 text-center z-10">
                    <div className="max-w-4xl mx-auto">
                        ...
                        <div className="flex justify-center space-x-8">
                            <a href="https://github.com/Azra-dev-DEFI" className={`${textMuted} hover:text-gray-600 transition-all duration-300 hover:scale-125`}>
                                <FaGithub className="w-8 h-8" />
                            </a>
                            <a href="https://www.linkedin.com/in/rajah-ibrahim/" className={`${textMuted} hover:text-gray-600 transition-all duration-300 hover:scale-125`}>
                                <FaLinkedin className="w-8 h-8" />
                            </a>
                            <a href="https:///x.com/Coachrajah" className={`${textMuted} hover:text-gray-600 transition-all duration-300 hover:scale-125`}>
                        ...
                        {projects.map((project, index) => (
                            <div key={index} className={`${bgCard} rounded-2xl p-8 hover:transform hover:scale-105 transition-all duration-300 ${border} border shadow-xl hover:shadow-2xl`}>
                                ...
                                <div className="flex items-center gap-4">
                                    ...
                                    <a href={project.github} className={`${textMuted} ${hoverColor} transition-all duration-300 hover:scale-125`}>
                                        <FaGithub className="w-8 h-8" />
                                    </a>
                                    <a
                                        href={project.demo}
                                        className={`border-2 ${isDarkMode ? 'border-white hover:bg-white hover:text-black' : 'border-black hover:bg-black hover:text-white'} px-4 py-2 rounded-full font-semibold text-sm transition-all duration-300 hover:scale-105`}
                                        target="_blank"
                    ...
                    <div className="max-w-4xl mx-auto text-center">
                        ...
                        <div className="grid md:grid-cols-3 gap-8 mb-16">
                            <div className="text-center">
                                ...
                                <p className={`${textSecondary}`}>rajahibrahim3@gmail.com</p>
                            </div>
                            <div className="text-center">
                                <div className={`w-20 h-20 ${isDarkMode ? 'bg-gray-800' : 'bg-gray-100'} rounded-full flex items-center justify-center mx-auto mb-6 shadow-xl`}>
                                ...
                                <p className={`${textSecondary}`}>@Azra-dev-DEFI</p>
                            </div>
                            <div className="text-center">
                                <div className={`w-20 h-20 ${isDarkMode ? 'bg-gray-800' : 'bg-gray-100'} rounded-full flex items-center justify-center mx-auto mb-6 shadow-xl`}>
