                ...
                <div className="container mx-auto px-6 text-center z-10">
                    <div className="max-w-4xl mx-auto">
                        ...
                        <h1 className=" font-bold mb-6 tracking-tight">
                            ...
                            <span className="block mt-2 text-3xl "> Web3 & Blockchain Specialist</span>
                        </h1>
                        ...
                        <div className="flex justify-center space-x-8">
                            ...
                            <a href="www.linkedin.com/in/rajah-ibrahim" className={`${textMuted} hover:text-gray-600 transition-all duration-300 hover:scale-125`}>
                        ...
                        <div className="grid lg:grid-cols-2 gap-16 items-center">
                            <div>
                                ...
                                <p className={`text-lg ${textSecondary} mb-10 leading-relaxed`}>
                                    ...
                                    democratize finance and create new economic opportunities while enhancing growth.
                                </p>
                    ...
                    <div className="max-w-4xl mx-auto text-center">
                        ...
                        <div className="grid md:grid-cols-3 gap-8 mb-16">
                            <div className="text-center">
                                ...
                                <p className={`${textSecondary}`}>rajahibrhahim3@gmail.com</p>
                            </div>
                            <div className="text-center">
                                <div className={`w-20 h-20 ${isDarkMode ? 'bg-gray-800' : 'bg-gray-100'} rounded-full flex items-center justify-center mx-auto mb-6 shadow-xl`}>
                            ...
                            <div className="text-center">
                                ...
                                <p className={`${textSecondary}`}>in/rajah-ibrahim</p>
                            </div>
                        </div>
